...
```bash
# Task 1: MCP Basics
python3 task_1_mcp_basics.py

# Task 2: MCP + LangGraph
python3 task_2_mcp_langgraph.py

# Task 3: Multiple Servers
python3 task_3_multi_servers.py
```
...
python3 mcp_servers/calculator_server.py --test

# Test weather server
python3 mcp_servers/weather_server.py --test
```
